...
//      ******************************************************************
//
// This sketch shows how to use the "TouchUserInterfaceForArduino" to create menus 
// that also have sub menus.
// 
...
{   
  ...
  BUTTON_EXTENDED redButton   = {"Red",   90,                     80,     45,  25,   LCD_RED,   LCD_YELLOW,    LCD_ORANGE,    LCD_WHITE, UI_Font_9};
  BUTTON_EXTENDED blueButton  = {"Blue",  250,                    100,    90,  90,   LCD_BLUE,  LCD_LIGHTBLUE, LCD_LIGHTBLUE, LCD_NAVY,  UI_Font_16_Bold};
