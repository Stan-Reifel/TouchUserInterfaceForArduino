...
{  
  ...
  y += ySpacing * 2;
  ui.lcdSetCursorXY(ui.displaySpaceCenterX, y);
  ui.lcdPrintCentered("This is an example program for the Arduino");

  y += ySpacing;
  ui.lcdSetCursorXY(ui.displaySpaceCenterX, y);
  ui.lcdPrintCentered("Touch User Interface.  It shows how to add");

  y += ySpacing;
  ui.lcdSetCursorXY(ui.displaySpaceCenterX, y);
  ui.lcdPrintCentered("a hamburger menu to an application.");

  y += ySpacing * 2;
  ui.lcdSetCursorXY(ui.displaySpaceCenterX, y);
  ui.lcdPrintCentered("Copyright (c) 2023, S. Reifel & Company.");
